  ...
  return (
    <section ref={ref} id="hero" className="relative h-screen overflow-hidden">
      ...
      <div className="absolute inset-0" style={{
        background: 'linear-gradient(170deg, rgba(15,8,5,.25) 0%, rgba(15,8,5,.55) 55%, rgba(15,8,5,.92) 100%)'
      }} />
      ...
      >
        ...
        <div className="w-px h-14 bg-gradient-to-b from-caramel to-transparent" style={{ animation: 'scrollPulse 2s ease-in-out infinite' }} />
      </motion.div>
    </section>
  )
}
